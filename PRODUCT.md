...
Published claims are tied to repository, marketplace, test, and deployment receipts. Unknown or unfinished states remain visible instead of being presented as complete.
...
The repository contains the live catalog, generated plugin pages, The Beacon Wakes product and demo surfaces, static contract tests, Playwright journeys, and production deployment receipts recorded in Beads. No testimonials or commercial performance claims are established here.

## Product Principles

- Publish evidence-backed facts.
- Keep free guidance ungated.
- Preserve the adult boundary around contact and commerce.
- Make unfinished states explicit.
- Keep source, marketplace, and public presentation traceable to one another.

## Accessibility & Inclusion

Public pages preserve semantic navigation, keyboard focus, reduced-motion support, responsive layouts, and readable contrast. The Beacon Wakes parent guidance respects a child’s choice to stop and avoids coercive engagement patterns.
