...
<!-- METRICS:START -->
Marketplace data generated at `2026-09-26T16:24:59.413Z`, across 4234 listed plugins. GitHub stars, default-branch freshness, root manifest, and preview metadata are derived during the same refresh.

| Plugin | Family | What it does | Source | Marketplace | Stars | Views | Copies | Hearts |
| --- | --- | --- | --- | --- | --: | --: | --: | --: |
| **Bazaar** | Discovery and Building | The Omarchy marketplace in your bar. Search every listing, filter by category or kind, rank what is trending, save a private shortlist, inspect source, and copy safe install commands. | [repo](https://github.com/jeremylongshore/omarchy-bazaar-entry) | [Productivity](https://plugins.omarchy.org/plugin.html?id=io.github.jeremylongshore.bazaar) | 0 | 351 | 45 | 0 |
...
| **Capture Conveyor** | Desktop Workflow | Turn Omarchy screenshots into a keyboard-first inbox: view recent captures, capture or OCR a region, copy paths, and reveal files. | [repo](https://github.com/jeremylongshore/omarchy-capture-conveyor-entry) | [Widgets](https://plugins.omarchy.org/plugin.html?id=io.github.jeremylongshore.capture-conveyor) | 0 | 153 | 8 | 1 |
...
**16 of 16 listed** on the marketplace, 3523 views, 213 copies, 22 hearts, and 4 GitHub stars.
