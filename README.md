...
> Sixteen plugins for **Omarchy Quattro**, plus the widget template they are all built from. All sixteen are live in the marketplace. Every repository ships the same security lane, and every network body parses in a file a unit test can load without a shell.

**Built and maintained by [Jeremy Longshore](https://github.com/jeremylongshore) / [Intent Solutions](https://intentsolutions.io).**

**Portfolio site: [oma.intentsolutions.io](https://oma.intentsolutions.io)**

**Live work: [github.com/jeremylongshore](https://github.com/jeremylongshore?tab=repositories&q=omarchy)**

**Official marketplace: [plugins.omarchy.org](https://plugins.omarchy.org/index.html?author=jeremylongshore)**

[![Marketplace: 16 live](https://img.shields.io/badge/marketplace-16%20live-1a7f37)](https://plugins.omarchy.org/index.html?author=jeremylongshore)
...
<!-- METRICS:START -->
Marketplace data generated at `2026-09-20T16:03:33.135Z`, across 3634 listed plugins. GitHub stars, default-branch freshness, root manifest, and preview metadata are derived during the same refresh.

| Plugin | Family | What it does | Source | Marketplace | Stars | Views | Copies | Hearts |
| --- | --- | --- | --- | --- | --: | --: | --: | --: |
| **Bazaar** | Discovery and Building | The Omarchy marketplace in your bar. Search every listing, filter by category or kind, rank what is trending, save a private shortlist, inspect source, and copy safe install commands. | [repo](https://github.com/jeremylongshore/omarchy-bazaar-entry) | [Productivity](https://plugins.omarchy.org/plugin.html?id=io.github.jeremylongshore.bazaar) | 0 | 328 | 42 | 0 |
| **Pit Wall** | Sports | A Formula 1 race-weekend command post with countdowns, live order, gaps, flags, safety-car state, local-time schedules, and championship standings. | [repo](https://github.com/jeremylongshore/omarchy-pit-wall-entry) | [Widgets](https://plugins.omarchy.org/plugin.html?id=io.github.jeremylongshore.pit-wall) | 0 | 173 | 23 | 3 |
| **Wait State** | System Awareness | CPU, memory, and I/O pressure stalls in the bar, with bounded history and practical guidance so busy is not mistaken for blocked. | [repo](https://github.com/jeremylongshore/omarchy-wait-state-entry) | [System](https://plugins.omarchy.org/plugin.html?id=io.github.jeremylongshore.wait-state) | 0 | 174 | 10 | 0 |
| **MLB Booth** | Sports | Follow one MLB club from first-pitch countdown through the final out with score, inning, count, outs, bases, schedule, and division race. | [repo](https://github.com/jeremylongshore/omarchy-mlb-booth-entry) | [Widgets](https://plugins.omarchy.org/plugin.html?id=io.github.jeremylongshore.mlb-booth) | 1 | 133 | 9 | 2 |
| **X Files** | Signals and Feeds | Replies to your own X posts as a drainable queue of questions, gripes, and asks, with representative quotes and a hard API-spend cap. | [repo](https://github.com/jeremylongshore/omarchy-x-files-entry) | [Productivity](https://plugins.omarchy.org/plugin.html?id=io.github.jeremylongshore.x-files) | 0 | 173 | 2 | 1 |
| **Docket** | Focus and Delivery | GitHub pull requests as an obligation queue: reviews waiting on you, your blocked work, and branches ready to merge, oldest first. | [repo](https://github.com/jeremylongshore/omarchy-docket-entry) | [Developer Tools](https://plugins.omarchy.org/plugin.html?id=io.github.jeremylongshore.docket) | 0 | 178 | 4 | 1 |
| **Crew Chief** | Focus and Delivery | Claude Code, Codex, Herdr, and other agent sessions as a local attention queue. See working, blocked, and done, then focus the project that needs you. | [repo](https://github.com/jeremylongshore/omarchy-crew-chief-entry) | [Productivity](https://plugins.omarchy.org/plugin.html?id=io.github.jeremylongshore.crew-chief) | 0 | 198 | 18 | 3 |
| **Listening Post** | Signals and Feeds | Twenty-nine curated AI-vendor feeds in a four-lane radar for model releases, price changes, status incidents, and engineering posts. | [repo](https://github.com/jeremylongshore/omarchy-listening-post-entry) | [Widgets](https://plugins.omarchy.org/plugin.html?id=io.github.jeremylongshore.listening-post) | 0 | 492 | 22 | 0 |
| **Desk Transition** | System Awareness | Two safe Hyprland display actions: arrange active outputs left-to-right or focus the built-in panel, with a preview before anything changes. | [repo](https://github.com/jeremylongshore/omarchy-desk-transition-entry) | [Productivity](https://plugins.omarchy.org/plugin.html?id=io.github.jeremylongshore.desk-transition) | 0 | 230 | 16 | 2 |
| **Foundry** | Discovery and Building | Turn an ID, name, and pitch into a proof-ready Omarchy bar-widget draft with matched manifest copy, a unique banner, offline tests, CI, and security gates. | [repo](https://github.com/jeremylongshore/omarchy-foundry-entry) | [Developer Tools](https://plugins.omarchy.org/plugin.html?id=io.github.jeremylongshore.foundry) | 0 | 150 | 6 | 0 |
| **Loose Ends** | Focus and Delivery | Scan local Git repositories for uncommitted edits, unpushed commits, old stashes, detached heads, and interrupted operations, oldest first. | [repo](https://github.com/jeremylongshore/omarchy-loose-ends-entry) | [Productivity](https://plugins.omarchy.org/plugin.html?id=io.github.jeremylongshore.loose-ends) | 1 | 100 | 5 | 1 |
| **Capture Conveyor** | Desktop Workflow | Turn Omarchy screenshots into a keyboard-first inbox: view recent captures, capture or OCR a region, copy paths, and reveal files. | [repo](https://github.com/jeremylongshore/omarchy-capture-conveyor-entry) | [Widgets](https://plugins.omarchy.org/plugin.html?id=io.github.jeremylongshore.capture-conveyor) | 0 | 148 | 7 | 1 |
| **Workspace Storyboard** | Desktop Workflow | Turn live Hyprland workspaces into a local re-entry map with window counts, active titles, keyboard jumps, and a private context history. | [repo](https://github.com/jeremylongshore/omarchy-workspace-storyboard-entry) | [Widgets](https://plugins.omarchy.org/plugin.html?id=io.github.jeremylongshore.workspace-storyboard) | 0 | 282 | 8 | 2 |
...
| **Flow Boundary** | Focus and Delivery | Mark intentional starts and stops from the bar with a live FLOW or PAUSE state and a bounded local transition history. | [repo](https://github.com/jeremylongshore/omarchy-flow-boundary-entry) | [Productivity](https://plugins.omarchy.org/plugin.html?id=io.github.jeremylongshore.flow-boundary) | 0 | 308 | 6 | 1 |
...
**16 of 16 listed** on the marketplace, 3441 views, 202 copies, 21 hearts, and 4 GitHub stars.
...
# omaTrail
omarchy plugin add https://github.com/jeremylongshore/omarchy-omatrail-entry.git --enable
```

Manifest and screenshot status are checked from each repository root. Any mismatch stays visible in the generated site rather than being silently corrected here.
<!-- METRICS:END -->

## One shared architecture

All sixteen entries share one deliberate shell shape while telling different product stories. The shape lives in [`omarchy-widget-template`](https://github.com/jeremylongshore/omarchy-widget-template) and every entry inherits it:
...
The table above and `site/data/plugins.json` are generated from `plugins.json` plus the official marketplace catalog. Never hand-edit either generated surface:
...
It reads the ids and plugin families from [`plugins.json`](plugins.json) rather than deriving them from the catalog, so a marketplace rename cannot quietly delete a row. It reconciles lifecycle status and install commands with the official marketplace, then checks each public GitHub repository for stars, its default branch's latest commit, its root manifest, and `preview.png`. Manifest drift or a missing preview stays visible instead of being silently corrected. [A scheduled workflow](.github/workflows/refresh-metrics.yml) reruns the refresh daily and commits when facts move. Pull requests verify that the committed README, site snapshot, detail pages, and no-JavaScript index agree without racing live counters that can change during CI.

## Preview and deploy the portfolio

The site is dependency-light HTML, CSS, and JavaScript. Preview it from the repository root:
