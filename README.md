...
<!-- METRICS:START -->
Marketplace data generated at `2026-09-15T00:22:06.841Z`, across 3186 listed plugins. GitHub stars, default-branch freshness, root manifest, and preview metadata are derived during the same refresh.
...
| **Pit Wall** | Sports | A Formula 1 race-weekend command post with countdowns, live order, gaps, flags, safety-car state, local-time schedules, and championship standings. | [repo](https://github.com/jeremylongshore/omarchy-pit-wall-entry) | [Widgets](https://plugins.omarchy.org/plugin.html?id=io.github.jeremylongshore.pit-wall) | 0 | 169 | 22 | 3 |
| **Wait State** | System Awareness | CPU, memory, and I/O pressure stalls in the bar, with bounded history and practical guidance so busy is not mistaken for blocked. | [repo](https://github.com/jeremylongshore/omarchy-wait-state-entry) | [System](https://plugins.omarchy.org/plugin.html?id=io.github.jeremylongshore.wait-state) | 0 | 163 | 9 | 0 |
...
| **Listening Post** | Signals and Feeds | Twenty-nine curated AI-vendor feeds in a four-lane radar for model releases, price changes, status incidents, and engineering posts. | [repo](https://github.com/jeremylongshore/omarchy-listening-post-entry) | [Widgets](https://plugins.omarchy.org/plugin.html?id=io.github.jeremylongshore.listening-post) | 0 | 486 | 22 | 0 |
...
| **Loose Ends** | Focus and Delivery | Scan local Git repositories for uncommitted edits, unpushed commits, old stashes, detached heads, and interrupted operations, oldest first. | [repo](https://github.com/jeremylongshore/omarchy-loose-ends-entry) | [Productivity](https://plugins.omarchy.org/plugin.html?id=io.github.jeremylongshore.loose-ends) | 1 | 96 | 4 | 1 |
| **Capture Conveyor** | Desktop Workflow | Turn Omarchy screenshots into a keyboard-first inbox: view recent captures, capture or OCR a region, copy paths, and reveal files. | [repo](https://github.com/jeremylongshore/omarchy-capture-conveyor-entry) | [Widgets](https://plugins.omarchy.org/plugin.html?id=io.github.jeremylongshore.capture-conveyor) | 0 | 142 | 7 | 1 |
...
| **Flow Boundary** | Focus and Delivery | Mark intentional starts and stops from the bar with a live FLOW or PAUSE state and a bounded local transition history. | [repo](https://github.com/jeremylongshore/omarchy-flow-boundary-entry) | [Productivity](https://plugins.omarchy.org/plugin.html?id=io.github.jeremylongshore.flow-boundary) | 0 | 304 | 6 | 1 |
...
**16 of 16 listed** on the marketplace, 3331 views, 189 copies, 19 hearts, and 3 GitHub stars.
